            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <form method="POST" class="form" action="updateMahasiswa{{$mahasiswa->id}}">
                            @csrf
                            <div class="row">
                                            ...
                                            <div>
                                                <div class="form-check-inline">
                                                    <input class="form-check-input" type="radio" name="kelas"
                                                        id="kelas" data-parsley-required="true" value="A" {{ $mahasiswa->kelas == 'A' ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check-inline">
                                                    <input class="form-check-input" type="radio" name="kelas"
                                                        id="kelas" value="B" {{ $mahasiswa->kelas == 'B' ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check-inline">
                                                    <input class="form-check-input" type="radio" name="kelas"
                                                        id="kelas" value="C" {{ $mahasiswa->kelas == 'C' ? 'checked' : '' }}>
